...
public class StringUtil {
	 ...
	 * @return
	 */
	public static String mkSelect(List<CodeVO> list, String page_size,
			String selectNm,
			boolean allYN){
		/*
		 * <select name="page">
		...
		for(CodeVO dto:list){
			sb.append("<option value='"+dto.getDtlCdId()+"' ");
			if(page_size.equals(dto.getDtlCdId())){
				sb.append("selected='selected'");	
			}
			sb.append(">");
			sb.append(dto.getDtlCdNm());
			sb.append("</option>\n");
		}
		sb.append("</select>  \n");
